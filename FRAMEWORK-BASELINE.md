...
# AgentZeroFramework dependency

## Purpose

Identify the exact framework architecture used to align this project without copying the framework into this repository or silently adopting future revisions.
...
ARCH-PRJ-001 defines this project's objectives and stages. RULE-PRJ-001 sets local scope and source-access controls. STD-DOC-001 governs local documents. These remain local project objects. Record any conflict with an adopted framework rule for review rather than inventing a precedence rule.

Related documents: ARCH-PRJ-001, RULE-PRJ-001, STATE-ROOT-001.
